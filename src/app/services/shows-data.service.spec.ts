...
describe('ShowsDataService', () => {
  ...
  let mockShows: ShowDetails[] = require('../mocks/shows.mock.json');
  let mockSearch: SearchShow[] = require('../mocks/search.mock.json');
  beforeEach(() => {
  ...
  it('should GET all shows', () => {
    ...
    let req: TestRequest = httpTestingController.expectOne('http://api.tvmaze.com/shows');
  ...
  it('should GET all shows returned from search', () => {
    ...
    let req: TestRequest = httpTestingController.expectOne(`http://api.tvmaze.com/search/shows?q=${searchTerm}`);
  ...
  it('should GET the details of the show correctly', () => {
    ...
    let req: TestRequest = httpTestingController.expectOne(`http://api.tvmaze.com/shows/${showId}`);
